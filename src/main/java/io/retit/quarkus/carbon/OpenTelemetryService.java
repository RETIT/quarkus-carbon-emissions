...
public class OpenTelemetryService {
    ...
    @Startup
    public void init() {
        // This call is only required during development as Quarkus restarts automatically for code changes
        GlobalOpenTelemetry.resetForTest();
        Resource resource = Resource.getDefault()
                .merge(Resource.create(Attributes.of(ResourceAttributes.SERVICE_NAME, "quarkus-carbon-emissions-testservice")));
